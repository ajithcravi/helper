...
let generateMandatoryTableRecords = () => {
    ...
    config.Concept.MandatoryTableRecords.forEach((tableName, index) => {
        mandatoryTableRecords += `                "${tableName.toLowerCase()}"`
        if(index < config.Concept.MandatoryTableRecords.length-1) mandatoryTableRecords += ",\n"
    });
